...
# Get templates
cp ${DARTMNGDIR}/template/input.nml.filter_default ${SCRATCHDIR}/
cp ${DARTMNGDIR}/template/input.nml.roms_to_dart_default ${SCRATCHDIR}/
cp ${DARTMNGDIR}/template/input.nml.dart_to_roms_default ${SCRATCHDIR}/
