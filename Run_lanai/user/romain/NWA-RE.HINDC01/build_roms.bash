...
export        MY_ROOT_DIR=/glade/p/work/romaines/Tools/ROMS/
...
export        USE_FFTW=off               # Use FFTW library
...
# Put the binary to execute in the following directory.
 ...
 export            BINDIR=/glade/scratch/romaines//dart/tmpdir_NWA-RE.HINDC01/
